...
angular.module('myApp.login', ['ngRoute', 'ngAnimate', 'ui.bootstrap'])
    ...
    .controller('loginCtrl', ['$rootScope', '$scope', '$location', '$timeout', '$filter', '$q', function ($rootScope, $scope, $location, $timeout, $filter, $q) {


            $scope.login = function () {
                $scope.dataLoading = true;
                $scope.checkLogin($scope.username, $scope.password, function (response) {
                    if (response.success) {
            ...
            $scope.checkLogin = function (username, password, callback) {
