...
public class QueryBuilderArticle implements QueryBuilder<ArticleQuery> {
    ...
    public String buildQuery(ArticleQuery query) {
        ...
        QueryElementRange ratingFilter = new QueryElementRange("_val_", query.getRating_low(), query.getRating_high(), "_val_:\"div(sumRatings_counter,countRatings_counter)\"");
        QueryElementRange votesFilter = new QueryElementRange("countRatings_counter", query.getVotes_low(), query.getVotes_high());
    ...
    private String formatPrice(Integer value) {
        return (value == null) ? null : String.format(RibayConstants.NUMBERFORMAT_PRICE_SEARCH, value);
    }
